...
import { IEditProfileError, IEditProfileInfo, IEditProfileLabels, IEditProfileRequest } from "../../types";
...
export const EditProfileInputs = ( { errors, onChange, infoLabels, data }: EditProfileInputProps) => {
  ...
  const [house_number, setUserhousenumber] = useTextInput(data?.profile?.house_number);
  const [mail, setUsermail] = useTextInput(data?.profile?.mail);
  const [phone, setUserphone] = useTextInput(data?.profile?.phone);
  const [postal_code, setUserpostalcode] = useTextInput(data?.profile?.postal_code);
  ...
  const [consultation_hours, setUserconsultationhours] = useTextInput(data?.profile?.consultation_hours);
  const [first_pregnancy, setUserfirstpregnancy] = useToggleInput(data?.profile?.first_pregnancy);
  const [phone_private, setUserphoneprivate] = useTextInput(data?.profile?.phone_private);




  useEffect(() => {
    if (onChange && (street || forename || surname || city || house_number || mail || phone || postal_code ||
                    prefix || suffix || room || website || consultation_hours || first_pregnancy || phone_private)) {
      onChange({
        profile: { street,forename , surname , city , house_number , mail , phone , postal_code ,  prefix ,
                   suffix, room, website, consultation_hours,first_pregnancy,phone_private }
      });
    }
  }, [street ,forename , surname , city , house_number , mail , phone , postal_code , 
      prefix , suffix, room, website, consultation_hours,first_pregnancy, phone_private]
  
  );

  const baseProfileLabels = infoLabels?.find(x => x.key == "profile")?.texts;
  const caregiverLabels = infoLabels?.find(x => x.key == "profile_caregiver")?.texts;
  const parentLabels = infoLabels?.find(x => x.key == "profile_parent")?.texts;
  const midwifeLabels = infoLabels?.find(x => x.key == "profile_midwife")?.texts;

  return (
    <>
      <TextInput
        id ={baseProfileLabels?.street? `${baseProfileLabels?.street}` : " " } 
        labelText = {baseProfileLabels?.street? `${baseProfileLabels?.street}` : " " } 
      ...
      />
      <TextInput
        id= {baseProfileLabels?.forename? `${baseProfileLabels?.forename}` : " " } 
        labelText = {baseProfileLabels?.forename? `${baseProfileLabels?.forename}` : " " } 
     ...
     <TextInput
        ...
        labelText =  {baseProfileLabels?.surname? `${baseProfileLabels?.surname}` : " " } 
    ...
    <TextInput
        id={baseProfileLabels?.house_number? `${baseProfileLabels?.house_number}` : " " } 
        labelText =  {baseProfileLabels?.house_number? `${baseProfileLabels?.house_number}` : " " } 
    ...
    <TextInput
        ...
        labelText =  {baseProfileLabels?.phone? `${baseProfileLabels?.phone}` : " " } 
    ...
    <TextInput
        id={baseProfileLabels?.postal_code? `${baseProfileLabels?.postal_code}` : " " } 
        labelText =  {baseProfileLabels?.postal_code? `${baseProfileLabels?.postal_code}` : " " } 
    ...
    <TextInput
        ...
        labelText = {baseProfileLabels?.prefix? `${baseProfileLabels?.prefix}` : " " } 
      ...
      <TextInput
        ...
        labelText =  {baseProfileLabels?.suffix? `${baseProfileLabels?.suffix}` : " " } 
      ...
      <>
        ...
        />
         <TextInput
          ...
          labelText =  {caregiverLabels?.website? `${caregiverLabels?.website}` : " " } 
        ...
        />
        <TextInput
          id = {caregiverLabels?.consultation_hours? `${caregiverLabels?.consultation_hours}` : " " } 
          labelText = {caregiverLabels?.consultation_hours? `${caregiverLabels?.consultation_hours}` : " " } 
...
<>
  <Toggle
    id = {parentLabels?.first_pregnancy? `${parentLabels?.first_pregnancy}` : " " } 
    labelText ={parentLabels?.first_pregnancy? `${parentLabels?.first_pregnancy}` : " " } 
...
<>
  ...
  <TextInput
    id = {midwifeLabels?.phone_private? `${midwifeLabels?.phone_private}` : " " } 
    labelText ={midwifeLabels?.phone_private? `${midwifeLabels?.phone_private}` : " " } 
  ...
  />
   <TextInput
          ...
          labelText ={midwifeLabels?.website? `${midwifeLabels?.website}` : " " } 
          onChange={setUserwebsite}
          invalid={!!errors?.profile?.website}
          invalidText={errors?.profile?.website}
          value={website}
        />
  <TextInput
          id = {midwifeLabels?.consultation_hours? `${midwifeLabels?.consultation_hours}` : " " } 
          labelText = {midwifeLabels?.consultation_hours? `${midwifeLabels?.consultation_hours}` : " " } 
          onChange={setUserconsultationhours}
          invalid={!!errors?.profile?.consultation_hours}
          invalidText={errors?.profile?.consultation_hours}
          value={consultation_hours}
