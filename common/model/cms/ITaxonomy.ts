...
export interface ITaxonomy extends IEntity, ISlug, ITranslations<ITranslatable>  {
  parent?: number
}

export function isITaxonomy(obj: any) : obj is ITaxonomy {
  return (obj && obj.parent !== undefined && isIEntity(obj) && isISlug(obj) && isITranslations(obj)) ? true : false;
}
